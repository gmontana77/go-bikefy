          ...
          <Col lg={15} sm={24}>
              ...
              {bookings.filter(o=>o.user==user._id).map((booking) => {
               return <Row gutter={16} className='bs1 m-2 text-left'>
                    <Col lg={6} sm={24}>
                        <p>Brand: <b>{booking.bike.name}</b></p>
                        <p>Total days: <b>{booking.totalDays}</b></p>
                        <p>Rent per day: <b>€{booking.bike.rentPerDay}</b></p>
                    ...
                    <Col lg={10} sm={24}>
                        ...
                        <img style={{borderRadius:5}} src={booking.bike.image} alt="bike for rent" height="340" className="p-2"/>
                        </Col>
                    <Col lg={8} sm={24}>
